package com.snwolf.mianshi.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.snwolf.mianshi";
        String dataName = "用户";         // 数据表的中文名
        String dataKey = "user";     // 表的唯一标识
        String upperDataKey = "User";    // 大写的Keu
